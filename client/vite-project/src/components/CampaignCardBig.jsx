...
import styles from "./CampaignCardBig.module.css";
...
const CampaignCardBig = ({ campaign, onSave, onUnsave, isSaved }) => {
      ...
      <div className={styles.content}>
        <div className={styles.creatorNProfile}>
          ...
          <div className={styles.creatorInfo}>
            ...
            <div className="text-sm text-gray-500 hover:underline">{creator.name}</div>
        ...
        <div className={styles.bigOverlay}>
          <div className={styles.bigDescription}>{campaign.description}</div>
          <div
            className={styles.bigCategory}
            onClick={(e) => {
              e.stopPropagation();
          ...
          {campaign.location && (
            <div className={styles.bigLocation}>{campaign.location}</div>
          )}
...
export default CampaignCardBig;
